...
<body>
<!-- <p class="switch"><a href="login_admin.php" title="administrateurs"> Espace Administrateur</a></p> -->
<div class="container">
<?php
$errors = '';
...
*/
		$sql='SELECT * FROM `user` WHERE `enseignantID` IS NOT NULL AND `email`="'.$_POST['email'].'"';
...
?>
    ...
    <div class="login-help">
      <p>Pour retourner sur la page de connexion? <a href="login.php">Cliquez ici</a>.</p>
    </div>
...
?>
 <div class="login">
      <h1>Connexion: Gestion des services</h1>
    ...
    <div class="login-help">
      <p>Mot de passe oublié? <a href="login.php?lostPass">Cliquez ici pour le réinitialiser</a>.</p>
    </div>
