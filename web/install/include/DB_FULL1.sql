...
CREATE TABLE `affectation` (
  `enseignantID` int(11) NULL DEFAULT NULL,
  ...
  `partage` tinyint(2) NOT NULL DEFAULT '0',
...
-- Table affectation_partage

DROP TABLE IF EXISTS `affectation_partage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `affectation_partage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `enseignantID` (`enseignantID`),
  CONSTRAINT `FK_aff_partage_aff_id` FOREIGN KEY (`affectationID`) REFERENCES `affectation` (`affectationID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_aff_partage_ens_id` FOREIGN KEY (`enseignantID`) REFERENCES `enseignant` (`enseignantID`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `affectation_partage` WRITE;
/*!40000 ALTER TABLE `affectation_partage` DISABLE KEYS */;
/*!40000 ALTER TABLE `affectation_partage` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `configuration_globale` VALUES (1,'smtp_host','smtp.mail.yahoo.com'),(2,'smtp_user','gestion_services_fstf@yahoo.com'),(3,'smtp_pass','gsFSTF2014'),(4,'smtp_port','465'),(5,'site_name','Gestion des services FSTF');
...
INSERT INTO `element_module` VALUES ('-1','Algorithmique et programmation 1',20,20,20,1,1,1,1),('-1','Algorithmique et programmation 2',24,18,18,1,2,2,1),('-1','Structures de données',20,20,20,1,3,3,1),('-1','Systèmes d\'information et bases de données',20,20,20,1,4,4,1),('-1','Bases de données',22,14,24,1,5,5,1),('-1','Bases de données',22,14,24,1,6,6,1),('-1','1/2 Mod Architecture 2',20,12,12,1,7,7,1),('-1','1/2 mod Système d\'exploitation 2',20,12,12,1,8,8,1),('-1','1 mod Réseaux',40,24,24,1,9,9,1),('-1','1 mod SI & Base de données',40,24,24,1,10,10,1),('-1','1/2 mod Prog Orientée Objet',20,12,12,1,11,11,1),('-1','1/2 mod  Interface Homme machine',20,12,12,1,12,12,1),('-1','1/2 mod Génie Logiciel',20,12,12,1,13,13,1),('-1','1/2 mod UML',20,12,12,1,14,14,1),('-1','1/2 mod Techniques de Web',20,12,12,1,15,15,1),('-1','1/2 mod Multimédia',20,12,12,1,16,16,1),('-1','POO',28,0,28,1,17,17,1),('-1','Architecture Client-Serveur',20,0,36,1,18,18,1),('-1','Systèmes répartis',18,21,17,1,19,19,1),('-1','Intelligence artificielle',22,17,17,1,20,20,1),('-1','Génie logiciel',28,10,18,1,21,21,1),('-1','Administration réseaux',30,13,13,1,22,22,1),('-1','Technologie JEE',34,0,22,1,23,23,1),('-1','Traitement de la parole',22,17,17,1,24,24,1),('-1','Traitement de la parole',20,13,23,1,25,25,1),('-1','Techniques d\'apprentissage et d’aide à la décision',20,18,18,1,26,26,1),('-1','Les entrepôts de données',30,13,13,1,27,27,1),('-1','1 mod Reconnaissance de Formes',20,20,40,1,28,28,1),('-1','1 mod Réseaux de Nouvelle Génération',60,0,16,1,29,29,1),('-1','1/2 Gestion de projet',8,12,10,1,30,30,1),('-1','1 mod Web Sémantique / WebServices ',36,0,40,1,31,31,1),('-1','Syst d\'exploitation Unix/Linux',22,12,22,1,32,32,1),('-1','POO C++/Java',26,14,16,1,33,33,1),('-1','Porgrammation C++',26,14,16,1,34,34,1),('-1','1/2 Complexité et pb d\'ordonnancement',14,14,0,1,35,35,1),('-1','1 mod Réseaux Informatiques',20,20,20,1,36,36,1),('-1','1 mod Prog Orientée Objet',20,20,20,1,37,37,1),('-1','1 mod Outils Informatiques de Développement',20,20,20,1,38,38,1);
...
INSERT INTO `element_module_actif` VALUES (1,1,1,1),(2,2,1,1),(3,3,1,1),(4,4,1,1),(5,5,1,1),(6,6,1,1),(7,7,1,1),(8,8,1,1),(9,9,1,1),(10,10,1,1),(11,11,1,1),(12,12,1,1),(13,13,1,1),(14,14,1,1),(15,15,1,1),(16,16,1,1),(17,17,1,1),(18,18,1,1),(19,19,1,1),(20,20,1,1),(21,21,1,1),(22,22,1,1),(23,23,1,1),(24,24,1,1),(25,25,1,1),(26,26,1,1),(27,27,1,1),(28,28,1,1),(29,29,1,1),(30,30,1,1),(31,31,1,1),(32,32,1,1),(33,33,1,0),(34,34,1,1),(35,35,1,1),(36,36,1,1),(37,37,1,1),(38,38,1,1);
...
INSERT INTO `element_module_details` VALUES (1,1,2,7,1,1),(1,1,2,8,2,2),(1,1,2,9,3,3),(1,1,2,10,4,4),(1,1,2,11,5,5),(1,1,2,12,6,6),(1,0,2,18,7,7),(1,1,2,19,8,8),(1,1,2,20,9,9),(1,1,2,21,10,10),(1,1,1,28,11,11),(1,0,1,29,12,12),(1,1,1,30,13,13),(1,0,1,31,14,14),(1,1,2,13,15,15),(1,1,2,14,16,16),(1,1,2,15,17,17),(1,1,2,16,18,18),(1,1,2,22,19,19),(1,0,2,23,20,20),(1,1,2,24,21,21),(1,1,2,25,22,22),(1,1,2,26,23,23),(1,1,2,27,24,24),(2,10,20,1,25,25),(2,10,20,2,26,26),(2,10,20,3,27,27),(2,10,20,4,28,28),(2,10,20,5,29,29),(2,10,20,6,30,30),(1,1,2,34,31,31),(1,1,0,35,32,32),(1,0,2,17,33,33),(1,1,2,32,34,34),(1,1,2,36,35,35),(1,1,2,37,36,36),(1,1,2,38,37,37);
...
INSERT INTO `filiere` VALUES ('TC MIP',1,1,NULL,1),('TC BCG',2,1,NULL,1),('LST Info',3,1,1,1),('MST SIR',4,2,1,1),('F.I. SET',5,3,NULL,1),('MST Maths',6,2,2,1),('MST ESSA',7,2,NULL,1),('LST GE',8,1,NULL,1);
...
INSERT INTO `filiere_actif` VALUES (1,1,1,1),(2,2,1,1),(3,3,1,1),(4,4,1,1),(5,5,1,1),(6,6,1,1),(7,7,1,1),(8,8,1,1);
...
INSERT INTO `grade_actif` VALUES (1,1,1,250,1),(2,2,1,291,1),(3,3,1,312,1),(4,4,1,291,1),(5,5,1,150,1);
...
INSERT INTO `module` VALUES ('','Algorithmique et programmation 1',1,1,1,1),('','Algorithmique et programmation 2',3,2,1,1),('','Structures de données',4,3,1,1),('','Systèmes d\'information et bases de données',4,4,1,1),('','Bases de données',3,5,2,1),('','Bases de données',2,6,2,1),('','Architecture 2',5,7,3,1),('','Système d\'exploitation 2',5,8,3,1),('','Réseaux',5,9,3,1),('','SI & Base de données',5,10,3,1),('','Prog Orientée Objet',5,11,3,1),('','Interface Homme machine',5,12,3,1),('','Génie Logiciel',6,13,3,1),('','UML',6,14,3,1),('','Techniques de Web',6,15,3,1),('','Multimédia',6,16,3,1),('','POO',2,17,6,1),('','Architecture Client-Serveur',1,18,4,1),('','Systèmes répartis',1,19,4,1),('','Intelligence artificielle',1,20,4,1),('','Génie logiciel',1,21,4,1),('','Administration réseaux',2,22,4,1),('','Technologie JEE',2,23,4,1),('','Traitement de la parole',2,24,4,1),('','Traitement d\'image',2,25,4,1),('','Techniques d\'apprentissage et d’aide à la décision',2,26,4,1),('','Les entrepôts de données',2,27,4,1),('','Reconnaissance de Formes',3,28,4,1),('','Réseaux de Nouvelle Génération',3,29,4,1),('','Gestion de projet',3,30,4,1),('','Web Sémantique / WebServices',3,31,4,1),('','Syst d\'exploitation Unix/Linux',1,32,7,1),('','POO C++/Java',1,33,7,1),('','Porgrammation C++',5,34,8,1),('','Complexité et pb d\'ordonnancement',1,35,6,1),('','Réseaux Informatiques',3,36,5,1),('','Prog Orientée Objet',3,37,5,1),('','Outils Informatiques de Développement',4,38,5,1);
...
INSERT INTO `module_details` VALUES (1,7,1,1,1,1,2),(1,8,1,2,1,1,2),(1,9,1,3,1,1,2),(1,10,1,4,1,1,2),(1,11,1,5,1,1,2),(1,12,1,6,1,1,2),(1,18,1,7,1,0,2),(1,19,1,8,1,1,2),(1,20,1,9,1,1,2),(1,21,1,10,1,1,2),(1,28,1,11,1,1,1),(1,29,1,12,1,0,1),(1,30,1,13,1,1,1),(1,31,1,14,1,0,1),(2,13,1,15,1,1,2),(2,14,1,16,1,1,2),(2,15,1,17,1,1,2),(2,16,1,18,1,1,2),(2,22,1,19,1,1,2),(2,23,1,20,1,0,2),(2,24,1,21,1,1,2),(2,25,1,22,1,1,2),(2,26,1,23,1,1,2),(2,27,1,24,1,1,2),(1,1,1,25,2,10,20),(1,2,1,26,2,10,20),(2,3,1,27,2,10,20),(2,4,1,28,2,10,20),(1,5,1,29,2,10,20),(2,6,1,30,2,10,20),(1,34,1,31,1,1,2),(1,35,1,32,1,1,0),(2,17,1,33,1,0,2),(1,32,1,34,1,1,2),(1,36,1,35,1,1,2),(1,37,1,36,1,1,2),(2,38,1,37,1,1,2);
...
-- Dump completed on 2014-07-01  4:55:21
